        ...
        <div class="tab-content" id="myTabContent">
            <div aria-labelledby="home-tab" id="home" class="tab-pane fade  active in" role="tabpanel">
                <table class="table table-bordered " id="table">
                    ...
                    <tr>
                        <th width="20%">类型</th>
                        <td><?php echo $data_zm['data'][0]['qylxmc']; ?></td>
                        <th >法定代表人</th>
                        <td><?php echo $data_zm['data'][0]['fddbr']; ?></td>
                    </tr>
                    <tr>
                        <th width="20%">注册资本</th>
                        <td><?php echo $data_zm['data'][0]['zczb']; ?></td>
                        <th >成立日期</th>
                        <td><?php echo $data_zm['data'][0]['clrq']; ?></td>
                    </tr>
                    <tr>
                        <th width="20%">营业期限自</th>
                        <td><?php echo $data_zm['data'][0]['yyrq1']; ?></td>
                        <th >营业期限至</th>
                        <td><?php echo $data_zm['data'][0]['yyrq2']; ?></td>
                    </tr>
                    <tr>
                        <th width="20%">登记机关</th>
                        <td><?php echo $data_zm['data'][0]['djjgmc']; ?></td>
                        <th >核准日期</th>
                        <td><?php echo $data_zm['data'][0]['hzrq']; ?></td>
                    </tr>
                    <tr>
                        <th width="20%">住所</th>
                        <td><?php echo $data_zm['data'][0]['zs']; ?></td>
                        <th >登记状态</th>
                        <td><?php echo $data_zm['data'][0]['mclxmc']; ?></td>
                    </tr>
                    <tr>
                        <th>经营范围</th>
                    ...
                    <tr>
                        <td><?php echo $data_bg['data'][0]['xm']; ?></th>
                    </tr>

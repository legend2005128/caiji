        ...
        <div class="tab-content" id="myTabContent">
            <div aria-labelledby="home-tab" id="home" class="tab-pane fade  active in" role="tabpanel">
                <table class="table table-bordered " id="table">
                    ...
                    <tr>
                        <th>注册资本</th>
                        <td width="20%"><?php echo $info_data['base']['regcap']; ?>万元人民币</td>
                        <th>成立日期</th>
                        <td><?php echo $info_data['base']['estdate']; ?></td>
                    </tr>
                    <tr>
                        <th>营业期限自</th>
                        <td width="20%"><?php
                            if (isset($info_data['base']['opfrom'])) {
                                echo $info_data['base']['opfrom'];
                            }
                            ?></td>
                        <th>营业期限至</th>
                        <td><?php
                            if (isset($info_data['base']['opto'])) {
                                echo $info_data['base']['opto'];
                            } else {
                                echo '永久';
                            }
                            ?></td>
                    ...
                    <tr>
                        <th>经营范围</th>
                        <td colspan="3"><?php echo $info_data['base']['opscope']; ?></td>
                    </tr>
                    <tr>
                        <th width="20%">登记机关</th>

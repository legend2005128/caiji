<div class="contanier">
    <h2>
        <?php echo $info_data['base']['entname']; ?>    注册号/统一社会信用代码：<?php echo $info_data['base']['creditcode']; ?>
    </h2>
            ...
            <div aria-labelledby="home-tab" id="home" class="tab-pane fade  active in" role="tabpanel">
                <table class="table table-bordered " id="table">
                    ...
                    <tr>
                        ...
                        <td width="30%"><?php echo $info_data['base']['creditcode']; ?></td>
                        <th width="20%">名称</th>
                    ...
                    <tr>
                        ...
                        <th >投资人</th>
                        <td><?php echo $info_data['base']['lerep']; ?></td>
                    </tr>
                    <tr>
                        <th>住所</th>
                        <td colspan="3"><?php echo $info_data['base']['dom']; ?></td>
                    </tr>
                    <tr>
                        <th>经营范围</th>
                    ...
                    <tr>
                        <th>登记机关</th>
                        <td width="20%"><?php echo $info_data['base']['regorg']; ?></td>
                        <th>核准日期</th>
                        <td><?php echo $info_data['base']['issblicdate']; ?></td>
                    </tr>
                    <tr>
                        <th width="20%">成立日期 	</th>
                        <td><?php echo $info_data['base']['apprdate']; ?></td>
                        <th>登记状态</th>
                        <td><?php echo $info_data['base']['opstate']; ?></td>
                    </tr>

                    <tr width="95%"><th colspan="4" style="text-align:center;">投资人信息</th></tr>
                    <tr>
                        <th>姓名</th>
                        <th>投资方式</td>
                    </tr>
                    <tr>
                        <td><?php echo $info_data['investors'][0]['name']; ?></th>
                        <td><?php echo $info_data['investors'][0]['sconform']; ?></td>
                    </tr>

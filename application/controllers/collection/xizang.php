...
class Xizang extends MY_Controller
{
    private $_base_url = 'http://gsxt.xzaic.gov.cn';
    private $_getdata_url = 'http://gsxt.xzaic.gov.cn/searchList.jspx';
    private $_verify_url = '';
    private $_checkcode_url = "http://gsxt.xzaic.gov.cn/checkCheckNo.jspx";
    protected $_cookies = 'xizang.cookie';
    function __construct()
    {
        parent::__construct();
        $this->cookie_jar .= $this->_cookies;
        $this->_verify_url = 'http://gsxt.xzaic.gov.cn/validateCode.jspx?type=0&id='.time();
    }
    ...
    public function serchlist(){
        ...
        $data['list'] = $date;
        $this->_render('xizang/serchlist',$data);
    }
    ...
    public function detail()
    {
        ...
        $this->_render('xizang/detail',$data);
        //保存html
...
//                make_html($path,iconv('utf-8','gb2312',$ob_content['content']));
            ...
            //保存sql
            save2db( array('id'=> get_uid(),'company_name'=>trim($title),'page_path'=>base_url("html/".$path),'province'=>'西藏'));
        }
    }

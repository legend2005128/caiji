...
class Zhixingren extends MY_Controller
{
    private $_origin = "http://zhixing.court.gov.cn/";
    private $_list_url;
    private $_yzm_url;
    private $_yzm_ck_url;
    private $_content_url ='http://zhixing.court.gov.cn/search/newsearch';

    protected $_name = '';//公司名
    protected $_vc = '';//验证码
    protected $_cookies = 'zhixingren.cookie';
    public $render_default = 'zhixingren/';

    function __construct()
    {
        parent::__construct();
        //验证码地址
        $this->_yzm_url = $this->_origin . '/search/security/jcaptcha.jpg?'.time();
        //验证码校验url
        $this->_yzm_ck_url = $this->_origin . '';
        //列表地址
        $this->_list_url = $this->_origin . '/search';
         //设置cookie
